...
{
    offerDetailTableViewController = [[OfferDetailTableViewController alloc] initWithNibName:@"OfferDetailTableViewController" bundle:nil];
    
    NSString *rowKey = [rowKeys nestedObjectAtIndexPath:indexPath];
    
    //Need to copy data instead??
    offerDetailTableViewController.data = [[NSMutableDictionary alloc] initWithDictionary:[data objectForKey:rowKey]
        copyItems:YES];
    
    [self.navigationController pushViewController:offerDetailTableViewController animated:YES];
}
